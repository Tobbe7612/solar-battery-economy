...
</p>**Solar Battery Economy** is a Home Assistant custom integration that analyzes the real economic performance of a **solar + battery energy system**.
...
```
Positive  = importing electricity
Negative  = exporting electricity
```
